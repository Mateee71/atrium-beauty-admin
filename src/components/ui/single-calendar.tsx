  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "space-y-2",
        month: "space-y-4",
        caption: "relative flex items-center justify-center py-1 text-sm font-medium",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-primary hover:text-primary-foreground"),
